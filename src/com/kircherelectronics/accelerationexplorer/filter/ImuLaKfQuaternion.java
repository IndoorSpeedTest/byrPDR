...
//		calculateOrientation();
	...
	public float[] setGyroscope(float[] gyroscope, long timeStamp)
	{	
		calculateOrientation();
		...
		float[] integrateOrientation = new float[3];
		
		integrateOrientation = calculateFusedOrientation();
		
		return integrateOrientation;
	}
...
//			hasOrientation = true;
//		}
		SensorManager.getRotationMatrix(rotationMatrix, baseOrientation, acceleration,
				magnetic);
		SensorManager.getOrientation(rotationMatrix, baseOrientation);
	 ...
	 */
	private float[] calculateFusedOrientation()
	{
